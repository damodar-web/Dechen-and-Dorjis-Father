# Dechen and Dorji’s father — ADT Bundle Reference
...
**Dechen and Dorji’s father** — This is a very early primary-level English reading book from Bhutan, published by the Ministry of Education and Skills Development, that introduces simple vocabulary and sentence patterns through a family farm setting. It focuses on familiar topics such as family members, the house, and domestic animals while reinforcing counting, colors, and basic observation questions. The language is English, and the short repetitive sentences suggest it is aimed at beginning readers, likely in the first years of primary school, with a gentle, picture-book style approach to literacy learning.
...
│   │   └── i18n/
│   │       └── {lang}/               # One directory per language: en
...
├── Dechen-and-Dorjis-Father-2023.db                    # SQLite database (pipeline state)
├── Dechen-and-Dorjis-Father-2023.pdf                   # Original source PDF
...
[
  ...
  { "section_id": "pg003_sec001", "href": "pg003_sec001.html", "page_number": 1 },
  { "section_id": "pg004_sec001", "href": "pg004_sec001.html", "page_number": 2 },
  { "section_id": "pg005_sec001", "href": "pg005_sec001.html", "page_number": 3 },
...
{
  "pg001_gp001_tx001": "",
  "pg003_im001": "A man carries a bundle of firewood and points to his house.",
  "gl001": "big",
  "gl001_def": "large in size",
  "qz001_que": "Which animal does Rinzin have three of?",
  "qz001_o0": "1) horses",
  "qz001_o0_exp": "✅ Correct! Rinzin says, "I have three horses and two cows.""
}
```
...
```json
{
  "title": "Dechen and Dorji’s father",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en"
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    data-correct-answers='{"qz001_o0":true,"qz001_o1":false,"qz001_o2":false}'
    data-option-explanations='{"qz001_o0":"qz001_o0_exp","qz001_o1":"qz001_o1_exp","qz001_o2":"qz001_o2_exp"}'>

    <p data-id="qz001_que">Which animal does Rinzin have three of?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="✅ Correct! Rinzin says, "I have three horses and two cows."" data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) horses</span>
    </label>
    <!-- more options... -->
</section>

<!-- Answers also embedded as JSON and in window.correctAnswers -->
<script type="application/json" id="quiz-correct-answers">{"qz001_o0":true,"qz001_o1":false,"qz001_o2":false}</script>
...
<script>window.correctAnswers = JSON.parse('{"qz001_o0":true,"qz001_o1":false,"qz001_o2":false}');</script>
```
...
| Original PDF | `Dechen-and-Dorjis-Father-2023.pdf` |
| Pipeline database | `Dechen-and-Dorjis-Father-2023.db` (SQLite) |
